...
for j in liste:       # déclaration de bloc par ":"
...
liste_de_liste_facile_a_lire = [[1,2,3],
                                [4,5,6],
                                [7,8,9]]
# accéder au premier element de la mere, accede au premier element de la sous liste
liste_de_liste_facile_a_lire[0][0]
...
# on cree un tuple sorte de liste
d = (3, False, None, 'chat')
type(d)
print(d[3])
